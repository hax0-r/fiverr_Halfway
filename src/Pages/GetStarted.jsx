...
const GetStarted = () => {
    return (
        ...
        <button className='rounded-full transition-all duration-500 cursor-pointer hover:bg-[#298b77] hover:scale-105 px-8 py-3.5 text-white bg-[#349f89] text-lg font-medium'>Get Started</button>
      </div>
        </>
    )
}
